...
def background(sky_color, far_mountains_sky_color,
    ...
    rect(screen, sky_color, (0, 0, width_of_background,
                             0.223 * length_of_background))
    rect(screen, far_mountains_sky_color, (0, 0.222 * length_of_background,
                                           width_of_background,
                                           0.223 * length_of_background))
    rect(screen, middle_mountains_sky_color, (0, 0.444 * length_of_background,
                                              width_of_background,
                                              0.223 * length_of_background))
    rect(screen, near_mountains_sky_color, (0, 0.666 * length_of_background,
                                            width_of_background,
                                            0.335 * length_of_background))
...
screen = pygame.display.set_mode((width_of_background, length_of_background))
